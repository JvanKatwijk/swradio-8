...
#include "../../../decoders/drm-decoder/word-collector.h"
...
static const char qt_meta_stringdata_wordCollector[] = {
    "wordCollector\0\0show_coarseOffset(float)\0"
...
void wordCollector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        wordCollector *_t = static_cast<wordCollector *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData wordCollector::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject wordCollector::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_wordCollector,
      qt_meta_data_wordCollector, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &wordCollector::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_wordCollector))
        return static_cast<void*>(const_cast< wordCollector*>(this));
