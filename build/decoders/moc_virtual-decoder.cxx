...
static const char qt_meta_stringdata_virtualDecoder[] = {
    "virtualDecoder\0\0,\0audioAvailable(int,int)\0"
    "setDetectorMarker(int)\0"
};
...
void virtualDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        virtualDecoder *_t = static_cast<virtualDecoder *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData virtualDecoder::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject virtualDecoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_virtualDecoder,
      qt_meta_data_virtualDecoder, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &virtualDecoder::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_virtualDecoder))
        return static_cast<void*>(const_cast< virtualDecoder*>(this));
