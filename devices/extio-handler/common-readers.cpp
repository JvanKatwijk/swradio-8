...
//
//
//	A couple of simple readers for the various devices.
//	Note that the rate parameter indicates the outputrate.
//	The inputrate is set in the base class.
//	The reader for 16 bit int values
//
	reader_16::reader_16 (ExtioHandler *p,
...
uint8_t	*p	= (uint8_t *)data;
	...
	store_and_signal (temp, blockSize);
}
...
//
	reader_24::reader_24 (ExtioHandler *p,
...
//
	reader_32::reader_32 (ExtioHandler *p,
...
//
	reader_float::reader_float (ExtioHandler *p, int32_t rate):
	                                             Reader_base (p, rate) {
}
